                                     ...
                                     child: Container(
                                      ...
                                      child: ListView(
                                        children: <Widget>[
                                         ...
                                         Text('%',style:TextStyle(color:Colors.white,fontSize:14,fontWeight:FontWeight.w900),),
                                              Text('تطبيق صادق 100',style:TextStyle(color:Colors.white,fontSize:14,fontWeight:FontWeight.w900),)
                                              ...
                                              Container(
                                                ...
                                                child:   FlatButton(
                                                  ...
                                                  UnityAds.showVideoAd(
                                                      placementId:
                                                     '3',
                                                     // 'Re2', //AdManager.rewardedVideoAdPlacementId,
                                                      listener: (state, args) {
                                                        print(
    ...
    //
                                                  ...
                                                  Container(
                                                      ...
                                                      child:   FlatButton(
                                                        ...
                                                        UnityAds.showVideoAd(
                                                            placementId:
                                                            'Re_3', //AdManager.rewardedVideoAdPlacementId,
                                                            listener: (state, args) {
                                                              print(
                                                                  'Rewarded Video Listener: $state => $args');
                                                              if (state == UnityAdState.complete) {
                                              ...
                                              Column(
                                                children: [
                                                  ...
                                                  Container(
                                                      child:Text("\$",style:TextStyle(color:Colors.white,fontSize:17,fontWeight:FontWeight.w900),)
                                                  ),
                                                ],
                                              ),
                                            ],
                                                          ...
                                                          else
                                                            {
                                                              showDialog(
                                                                  ...
                                                                  builder: (_) => new CupertinoAlertDialog(
                                                                    title: new Text("خطأ "),
                                                                    content: new Text(" يجب ان تحصل علي 1000 كوينز حتي تستطيع التحويل بنجاح"),
                                                         ...
                                                         if(money<1){
                                                            showDialog(
                                                                  ...
                                                                  builder: (_) => new CupertinoAlertDialog(
                                                                    ...
                                                                    content: new Text("يجب ان تحصل علي 1 من العملة كحد ادني لطلب الاستلام "),
                                                                  
                                                                  ));
                                                         }
                                                         else{

                                                        sendWhatsApp('+9647725256635','hello i am using wallpaper and ads app and my money = '+money.toString());
