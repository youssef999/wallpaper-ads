          ...
          child: Column(
            ...
            /*  Container(
              ...
              RaisedButton(
                  ...
                  child:Text('اربح من هنا ',style:TextStyle(color:Colors.white,fontSize:26,fontWeight:FontWeight.w700),)
              ...
              RaisedButton(
                  ...
                  child:Text('اختر خلفية ',style:TextStyle(color:Colors.white,fontSize:26,fontWeight:FontWeight.w700),)
